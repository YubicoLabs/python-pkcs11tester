...
SHA1_DI = b"\x30\x21\x30\x09\x06\x05\x2b\x0e\x03\x02\x1a\x05\x00\x04\x14"
SHA256_DI = (
...
P256_PARAMS = b"\x06\x08\x2a\x86\x48\xce\x3d\x03\x01\x07"
P384_PARAMS = b"\x06\x05\x2b\x81\x04\x00\x22"
P521_PARAMS = b"\x06\x05\x2b\x81\x04\x00\x23"
...
class Pkcs11Tester(unittest.TestCase):
    def setUp(self):
        ...
        if "YUBIHSM_PKCS11_MODULE" in os.environ:
            ...
            raise Exception(
                "YUBIHSM_PKCS11_MODULE must be set to the location of the pkcs11 module"
            )
        ...
        mechs = [
            {
                ...
                "m_mech": PyKCS11.CKM_SHA1_RSA_PKCS_PSS,
                "m_hash": PyKCS11.CKM_SHA_1,
                "mgf1": PyKCS11.CKG_MGF1_SHA1,
                "hash": hashes.SHA1(),
            },
            {
                "name": "CKM_SHA256_RSA_PKCS_PSS",
                "m_mech": PyKCS11.CKM_SHA256_RSA_PKCS_PSS,
                "m_hash": PyKCS11.CKM_SHA256,
                "mgf1": PyKCS11.CKG_MGF1_SHA256,
                "hash": hashes.SHA256(),
            },
            {
                "name": "CKM_SHA384_RSA_PKCS_PSS",
                "m_mech": PyKCS11.CKM_SHA384_RSA_PKCS_PSS,
                "m_hash": PyKCS11.CKM_SHA384,
                "mgf1": PyKCS11.CKG_MGF1_SHA384,
                "hash": hashes.SHA384(),
            },
            {
                "name": "CKM_SHA512_RSA_PKCS_PSS",
                "m_mech": PyKCS11.CKM_SHA512_RSA_PKCS_PSS,
                "m_hash": PyKCS11.CKM_SHA512,
                "mgf1": PyKCS11.CKG_MGF1_SHA512,
                "hash": hashes.SHA512(),
            },
        ]
    ...
    def generateSignEC(self, params, session):
        ...
        (pubkey, privkey) = session.generateKeyPair(
            public_template, private_template, mecha=PyKCS11.MechanismECGENERATEKEYPAIR
        )
        ...
        signature = session.sign(
            privkey, hashed, PyKCS11.Mechanism(PyKCS11.CKM_ECDSA, None)
        )

        res = session.verify(
            pubkey, hashed, signature, PyKCS11.Mechanism(PyKCS11.CKM_ECDSA, None)
        )
        self.assertTrue(res)
    ...
    def importRSA(self, session, length, decrypt=False, sign=False):
        key = rsa.generate_private_key(
            public_exponent=0x10001, key_size=length, backend=default_backend()
        )
        ...
        pubkey = session.findObjects(
            [
                (
                    PyKCS11.CKA_ID,
                    session.getAttributeValue(keyobj, [PyKCS11.CKA_ID])[0],
                ),
                (PyKCS11.CKA_CLASS, PyKCS11.CKO_PUBLIC_KEY),
            ]
        )[0]
    ...
    def testGenerateHmacSignVerify(self):
        session = self.login("0001password")
        for h in (
            PyKCS11.CKM_SHA_1_HMAC,
            PyKCS11.CKM_SHA256_HMAC,
            PyKCS11.CKM_SHA384_HMAC,
            PyKCS11.CKM_SHA512_HMAC,
        ):
            ...
            keyobj = session.generateKey(
                template, PyKCS11.Mechanism(PyKCS11.CKM_GENERIC_SECRET_KEY_GEN, None)
            )
    ...
    def testGeneratedWrap(self):
        ...
        wrapobj = session.generateKey(
            wrapTemplate, PyKCS11.Mechanism(PyKCS11.CKM_GENERIC_SECRET_KEY_GEN, None)
        )
        ...
        tosign = os.urandom(2000)
        signature = session.sign(
            keyobj, tosign, PyKCS11.Mechanism(PyKCS11.CKM_ECDSA_SHA256, None)
        )
        signature = decode_ec_sig(signature)
        eckey.public_key().verify(signature, tosign, ec.ECDSA(hashes.SHA256()))

        wrap = session.wrapKey(
            wrapobj, keyobj, mecha=PyKCS11.Mechanism(CKM_YUBICO_AES_CCM_WRAP, None)
        )

        session.destroyObject(keyobj)

        keyobj = session.unwrapKey(
            wrapobj, wrap, [], mecha=PyKCS11.Mechanism(CKM_YUBICO_AES_CCM_WRAP, None)
        )
    ...
    def testImportCertFind(self):
        ...
        self.assertEqual(
            len(objs), 3
        )  # this is returned as 3 objects, privkey, pubkey & cert
        for obj in objs:
        ...
        vectors = [
            {
                "key": b"\x0b" * 20,
                "chal": b"Hi There",
                "exp_sha1": b"\xb6\x17\x31\x86\x55\x05\x72\x64\xe2\x8b\xc0\xb6\xfb\x37\x8c\x8e\xf1\x46\xbe\x00",
                "exp_sha256": b"\xb0\x34\x4c\x61\xd8\xdb\x38\x53\x5c\xa8\xaf\xce\xaf\x0b\xf1\x2b\x88\x1d\xc2\x00\xc9\x83\x3d\xa7\x26\xe9\x37\x6c\x2e\x32\xcf\xf7",
                "exp_sha512": b"",
                "exp_sha384": b"\xaf\xd0\x39\x44\xd8\x48\x95\x62\x6b\x08\x25\xf4\xab\x46\x90\x7f\x15\xf9\xda\xdb\xe4\x10\x1e\xc6\x82\xaa\x03\x4c\x7c\xeb\xc5\x9c\xfa\xea\x9e\xa9\x07\x6e\xde\x7f\x4a\xf1\x52\xe8\xb2\xfa\x9c\xb6",
            },
            {
                "key": b"Jefe",
                "chal": b"what do ya want for nothing?",
                "exp_sha1": b"\xef\xfc\xdf\x6a\xe5\xeb\x2f\xa2\xd2\x74\x16\xd5\xf1\x84\xdf\x9c\x25\x9a\x7c\x79",
                "exp_sha256": b"\x5b\xdc\xc1\x46\xbf\x60\x75\x4e\x6a\x04\x24\x26\x08\x95\x75\xc7\x5a\x00\x3f\x08\x9d\x27\x39\x83\x9d\xec\x58\xb9\x64\xec\x38\x43",
                "exp_sha512": b"",
                "exp_sha384": b"\xaf\x45\xd2\xe3\x76\x48\x40\x31\x61\x7f\x78\xd2\xb5\x8a\x6b\x1b\x9c\x7e\xf4\x64\xf5\xa0\x1b\x47\xe4\x2e\xc3\x73\x63\x22\x44\x5e\x8e\x22\x40\xca\x5e\x69\xe2\xc7\x8b\x32\x39\xec\xfa\xb2\x16\x49",
            },
            {
                "key": b"\xaa" * 20,
                "chal": b"\xdd" * 50,
                "exp_sha1": b"\x12\x5d\x73\x42\xb9\xac\x11\xcd\x91\xa3\x9a\xf4\x8a\xa1\x7b\x4f\x63\xf1\x75\xd3",
                "exp_sha256": b"\x77\x3e\xa9\x1e\x36\x80\x0e\x46\x85\x4d\xb8\xeb\xd0\x91\x81\xa7\x29\x59\x09\x8b\x3e\xf8\xc1\x22\xd9\x63\x55\x14\xce\xd5\x65\xfe",
                "exp_sha512": b"",
                "exp_sha384": b"\x88\x06\x26\x08\xd3\xe6\xad\x8a\x0a\xa2\xac\xe0\x14\xc8\xa8\x6f\x0a\xa6\x35\xd9\x47\xac\x9f\xeb\xe8\x3e\xf4\xe5\x59\x66\x14\x4b\x2a\x5a\xb3\x9d\xc1\x38\x14\xb9\x4e\x3a\xb6\xe1\x01\xa3\x4f\x27",
            },
            {
                "key": b"\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10\x11\x12\x13\x14\x15\x16\x17\x18\x19",
                "chal": b"\xcd" * 50,
                "exp_sha1": b"\x4c\x90\x07\xf4\x02\x62\x50\xc6\xbc\x84\x14\xf9\xbf\x50\xc8\x6c\x2d\x72\x35\xda",
                "exp_sha256": b"\x82\x55\x8a\x38\x9a\x44\x3c\x0e\xa4\xcc\x81\x98\x99\xf2\x08\x3a\x85\xf0\xfa\xa3\xe5\x78\xf8\x07\x7a\x2e\x3f\xf4\x67\x29\x66\x5b",
                "exp_sha512": b"",
                "exp_sha384": b"\x3e\x8a\x69\xb7\x78\x3c\x25\x85\x19\x33\xab\x62\x90\xaf\x6c\xa7\x7a\x99\x81\x48\x08\x50\x00\x9c\xc5\x57\x7c\x6e\x1f\x57\x3b\x4e\x68\x01\xdd\x23\xc4\xa7\xd6\x79\xcc\xf8\xa3\x86\xc6\x74\xcf\xfb",
            },
        ]
        session = self.login("0001password")
        for v in vectors:
    ...
    def testDigest(self):
        vectors = [
            {
                "msg": "abc",
                PyKCS11.CKM_SHA_1: b"\xa9\x99\x3e\x36\x47\x06\x81\x6a\xba\x3e\x25\x71\x78\x50\xc2\x6c\x9c\xd0\xd8\x9d",
                PyKCS11.CKM_SHA256: b"\xba\x78\x16\xbf\x8f\x01\xcf\xea\x41\x41\x40\xde\x5d\xae\x22\x23\xb0\x03\x61\xa3\x96\x17\x7a\x9c\xb4\x10\xff\x61\xf2\x00\x15\xad",
                PyKCS11.CKM_SHA384: b"\xcb\x00\x75\x3f\x45\xa3\x5e\x8b\xb5\xa0\x3d\x69\x9a\xc6\x50\x07\x27\x2c\x32\xab\x0e\xde\xd1\x63\x1a\x8b\x60\x5a\x43\xff\x5b\xed\x80\x86\x07\x2b\xa1\xe7\xcc\x23\x58\xba\xec\xa1\x34\xc8\x25\xa7",
                PyKCS11.CKM_SHA512: b"",
            },
            {
                "msg": "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
                PyKCS11.CKM_SHA_1: b"\x84\x98\x3e\x44\x1c\x3b\xd2\x6e\xba\xae\x4a\xa1\xf9\x51\x29\xe5\xe5\x46\x70\xf1",
                PyKCS11.CKM_SHA256: b"\x24\x8d\x6a\x61\xd2\x06\x38\xb8\xe5\xc0\x26\x93\x0c\x3e\x60\x39\xa3\x3c\xe4\x59\x64\xff\x21\x67\xf6\xec\xed\xd4\x19\xdb\x06\xc1",
                PyKCS11.CKM_SHA384: b"\x33\x91\xfd\xdd\xfc\x8d\xc7\x39\x37\x07\xa6\x5b\x1b\x47\x09\x39\x7c\xf8\xb1\xd1\x62\xaf\x05\xab\xfe\x8f\x45\x0d\xe5\xf3\x6b\xc6\xb0\x45\x5a\x85\x20\xbc\x4e\x6f\x5f\xe9\x5b\x1f\xe3\xc8\x45\x2b",
                PyKCS11.CKM_SHA512: b"",
            },
            {
                "msg": "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
                PyKCS11.CKM_SHA_1: b"\xa4\x9b\x24\x46\xa0\x2c\x64\x5b\xf4\x19\xf9\x95\xb6\x70\x91\x25\x3a\x04\xa2\x59",
                PyKCS11.CKM_SHA256: b"\xcf\x5b\x16\xa7\x78\xaf\x83\x80\x03\x6c\xe5\x9e\x7b\x04\x92\x37\x0b\x24\x9b\x11\xe8\xf0\x7a\x51\xaf\xac\x45\x03\x7a\xfe\xe9\xd1",
                PyKCS11.CKM_SHA384: b"\x09\x33\x0c\x33\xf7\x11\x47\xe8\x3d\x19\x2f\xc7\x82\xcd\x1b\x47\x53\x11\x1b\x17\x3b\x3b\x05\xd2\x2f\xa0\x80\x86\xe3\xb0\xf7\x12\xfc\xc7\xc7\x1a\x55\x7e\x2d\xb9\x66\xc3\xe9\xfa\x91\x74\x60\x39",
                PyKCS11.CKM_SHA512: b"",
            },
        ]
    ...
    def testListSecretKeys(self):
        ...
        wrapobj = session.generateKey(
            wrap_template, PyKCS11.Mechanism(PyKCS11.CKM_GENERIC_SECRET_KEY_GEN, None)
        )
        ...
        hmacobj = session.generateKey(
            hmac_template, PyKCS11.Mechanism(PyKCS11.CKM_GENERIC_SECRET_KEY_GEN, None)
        )
